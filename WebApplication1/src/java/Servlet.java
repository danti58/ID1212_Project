    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ub != null){
            ...
            /*if(request.getParameter("createUser") != null){
                ...
                ub.setActivityMessage(request.getParameter("message"), 
                        Integer.parseInt(request.getParameter("sendMessage")));
                
                RequestDispatcher rd = request.getRequestDispatcher("View/allActivites.jsp");
                //RequestDispatcher rd = request.getRequestDispatcher("View/queue.jsp");
                rd.forward(request, response);  
            
            }else if(request.getParameter("toggleQueueStatus") != null){
                ub.toggleQueueStatus(Integer.parseInt(request.getParameter("toggleQueueStatus")));
                ...
                response.setHeader("Refresh", "10; URL=/WebApplication1/Servlet?openQueue=" + request.getParameter("openQueue"));
                RequestDispatcher rd = request.getRequestDispatcher("View/queue.jsp");
                rd.forward(request, response);  
